...
public:
	...
	ModelSTL*		m_STL_model;
	ModelSTL*		LoadSTLModel(char* name, SE3 T = SE3(0.0))
	{
		m_STL_model = new ModelSTL;
		T.ToArray(m_STL_model->_T);
		m_STL_model->Load(name);
		return m_STL_model;
	};
